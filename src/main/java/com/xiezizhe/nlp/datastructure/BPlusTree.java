package com.xiezizhe.nlp.datastructure;
...
/**
 * modified based on https://github.com/jiaguofang/b-plus-tree/blob/master/src/main/java/com/jgfanng/algo/BPlusTree.java
 * <p>
 * In memory B+ tree
 * Created by xiezizhe
 * Date: 2018/8/28 上午11:28
 */
        ...
        List<V> getRange(K key1, RangePolicy policy1, K key2,
            ...
            while (node != null) {
                ...
                while (kIt.hasNext()) {
                    ...
                    if (((policy1 == RangePolicy.EXCLUSIVE && cmp1 > 0) || (policy1 == RangePolicy.INCLUSIVE && cmp1
                            >= 0))
                            && ((policy2 == RangePolicy.EXCLUSIVE && cmp2 < 0) || (policy2 == RangePolicy.INCLUSIVE
                            && cmp2 <= 0)))
                        result.add(value);
